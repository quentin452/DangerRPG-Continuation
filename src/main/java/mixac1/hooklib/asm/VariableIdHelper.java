...
public class VariableIdHelper {
    ...
    public static List<String> listLocalVariables(final InputStream classData, final String methodName,
        final Type... argTypes) {
        ...
        final ClassVisitor cv = new ClassVisitor(327680) {
            ...
            public MethodVisitor visitMethod(final int acc, final String name, final String desc,
                ...
                if (methodName.equals(name) && desc.startsWith(methodDescWithoutReturnType)) {
                    return new MethodVisitor(327680) {
                        ...
                        public void visitLocalVariable(final String name, final String desc, final String signature,
                            ...
                            final String typeName = Type.getType(desc)
                                .getClassName();
    ...
    public static List<String> listLocalVariables(final String className, final String methodName,
        final Type... argTypes) {
        return listLocalVariables(ReadClassHelper.getClassData(className), methodName, argTypes);
    }

    public static void printLocalVariables(final InputStream classData, final String methodName,
        final Type... argTypes) {
