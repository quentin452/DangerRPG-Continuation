...
public abstract class HookInjectorMethodVisitor extends AdviceAdapter {
    ...
    protected HookInjectorMethodVisitor(final MethodVisitor mv, final int access, final String name, final String desc,
        final AsmHook hook, final HookInjectorClassVisitor cv) {
    ...
    public static class MethodEnter extends HookInjectorMethodVisitor {
        ...
        public MethodEnter(final MethodVisitor mv, final int access, final String name, final String desc,
            final AsmHook hook, final HookInjectorClassVisitor cv) {
    ...
    public static class MethodExit extends HookInjectorMethodVisitor {
        ...
        public MethodExit(final MethodVisitor mv, final int access, final String name, final String desc,
            final AsmHook hook, final HookInjectorClassVisitor cv) {
            super(mv, access, name, desc, hook, cv);
        }
    ...
    public static class LineNumber extends HookInjectorMethodVisitor {
        ...
        public LineNumber(final MethodVisitor mv, final int access, final String name, final String desc,
            final AsmHook hook, final HookInjectorClassVisitor cv, final int lineNumber) {
            super(mv, access, name, desc, hook, cv);
