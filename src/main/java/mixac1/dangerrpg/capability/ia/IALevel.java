...
public class IALevel extends IADynamic
{
    ...
    public void lvlUp(final ItemStack stack) {
        this.set(stack, Utils.alignment(((RPGItemRegister.RPGItemData)RPGCapability.rpgItemRegistr.get((Object)stack.getItem())).attributes.get(this).up(this.get(stack)), 1.0f, (float)RPGConfig.ItemConfig.d.maxLevel));
    }
}
