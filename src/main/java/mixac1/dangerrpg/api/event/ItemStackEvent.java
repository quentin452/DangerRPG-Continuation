...
public class ItemStackEvent extends Event
{
    ...
    public static class HitEntityEvent extends ItemStackEvent
    {
        ...
        public HitEntityEvent(final ItemStack stack, final EntityLivingBase entity, final EntityLivingBase attacker, final float damage, final float knockback, final boolean isRangeed) {
            super(stack);
            this.entity = entity;
    ...
    public static class DealtDamageEvent extends ItemStackEvent
    {
        ...
        public DealtDamageEvent(final EntityPlayer player, final EntityLivingBase target, final ItemStack stack, final float damage) {
            super(stack);
            this.player = player;
            this.target = target;
            this.damage = damage;
    ...
    public static class AddInformationEvent extends ItemStackEvent
    {
        ...
        public AddInformationEvent(final ItemStack stack, final EntityPlayer player, final List list, final boolean par) {
            super(stack);
            this.player = player;
            this.list = list;
            this.par = par;
    ...
    public static class StackChangedEvent extends ItemStackEvent
    {
        ...
        public StackChangedEvent(final ItemStack newStack, final ItemStack oldStack, final int slot, final EntityPlayer player) {
            super(newStack);
