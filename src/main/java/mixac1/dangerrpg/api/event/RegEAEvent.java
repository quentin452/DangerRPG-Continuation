...
public class RegEAEvent extends Event {
    ...
    protected RegEAEvent(final Class<? extends EntityLivingBase> entityClass,
    ...
    public static class DefaultEAEvent extends RegEAEvent {
        ...
        public DefaultEAEvent(final Class<? extends EntityLivingBase> entityClass,
    ...
    public static class EntytyLivingEAEvent extends RegEAEvent {
        ...
        public EntytyLivingEAEvent(final Class<? extends EntityLiving> entityClass,
            final RPGEntityRegister.RPGEntityData map) {
    ...
    public static class EntytyMobEAEvent extends RegEAEvent {
        ...
        public EntytyMobEAEvent(final Class<? extends EntityMob> entityClass,
            final RPGEntityRegister.RPGEntityData map) {
            super((Class<? extends EntityLivingBase>) entityClass, map);
        }
    }
    ...
    public static class PlayerEAEvent extends RegEAEvent {
        ...
        public PlayerEAEvent(final Class<? extends EntityPlayer> entityClass,
            final RPGEntityRegister.RPGEntityData map) {
            super((Class<? extends EntityLivingBase>) entityClass, map);
        }
    }
