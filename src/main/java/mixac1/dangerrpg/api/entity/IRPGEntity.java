...
public interface IRPGEntity {
    ...
    public static final IRPGEntity DEFAULT_PLAYER = new IRPGEntity() {
        ...
        @Override
        public void registerAttributes(final Class<? extends EntityLivingBase> entityClass,
    ...
    public static class RPGRangeEntityMob extends RPGEntityMob {
        ...
        public void registerAttributes(final Class<? extends EntityLivingBase> entityClass,
            ...
            if (this.rangeAttr != null) {
                set.registerEA(
                    (mixac1.dangerrpg.api.entity.EntityAttribute<Float>) this.rangeAttr,
                    this.rangeValue,
    ...
    public static class RPGCommonEntity extends RPGLivingEntity {
        ...
        public void registerAttributes(final Class<? extends EntityLivingBase> entityClass,
            ...
            if (this.meleeAttr != null) {
                set.registerEA(
                    (mixac1.dangerrpg.api.entity.EntityAttribute<Float>) this.meleeAttr,
                    this.meleeValue,
                    RPGEntityHelper.DAMAGE_MUL);
            }
            if (this.rangeAttr != null) {
