...
public class RPGToolMaterial implements IMaterialSpecial
{
    ...
    public static final RPGToolMaterial BEDROCK         = new RPGToolMaterial("bedrock",        EnumHelper.addToolMaterial("BEDROCK",      4, 4000,  18.0F, 11.0F, 14), 0x004400, RPGItemRarity.mythic);
    public static final RPGToolMaterial BLACK_MATTER    = new RPGToolMaterial("black_matter",   EnumHelper.addToolMaterial("BLACK_MATTER", 4, 8000,  36.0F, 21.0F, 19), 0x000000, RPGItemRarity.epic);
    public static final RPGToolMaterial WHITE_MATTER    = new RPGToolMaterial("white_matter",   EnumHelper.addToolMaterial("WHITE_MATTER", 5, 10000, 48.0F, 36.0F, 22), 0xffffff, RPGItemRarity.legendary);
