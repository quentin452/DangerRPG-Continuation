...
public class RPGToolMaterial implements IMaterialSpecial {
    ...
    public RPGToolMaterial(final String name, final Item.ToolMaterial material, final Integer color,
