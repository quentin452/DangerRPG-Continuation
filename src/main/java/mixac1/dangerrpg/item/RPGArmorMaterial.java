...
public class RPGArmorMaterial implements IMaterialSpecial
{
    ...
    public RPGArmorMaterial(final String name, final ItemArmor.ArmorMaterial material, final Integer color, final EnumRarity rarity) {
        this(name, material);
        this.color = color;
        this.rarity = rarity;
    }
    ...
    static {
        ...
        OBSIDIAN = new RPGArmorMaterial("obsidian", EnumHelper.addArmorMaterial("OBSIDIAN", 51, new int[] { 4, 8, 6, 4 }, 12), 15379456, RPGOther.RPGItemRarity.rare);
        BEDROCK = new RPGArmorMaterial("bedrock", EnumHelper.addArmorMaterial("BEDROCK", 102, new int[] { 7, 9, 8, 6 }, 14), 17408, RPGOther.RPGItemRarity.mythic);
        BLACK_MATTER = new RPGArmorMaterial("black_matter", EnumHelper.addArmorMaterial("BLACK_MATTER", 204, new int[] { 8, 10, 10, 8 }, 19), 1118481, RPGOther.RPGItemRarity.epic);
        WHITE_MATTER = new RPGArmorMaterial("white_matter", EnumHelper.addArmorMaterial("WHITE_MATTER", 286, new int[] { 10, 12, 12, 10 }, 22), 16777215, RPGOther.RPGItemRarity.legendary);
