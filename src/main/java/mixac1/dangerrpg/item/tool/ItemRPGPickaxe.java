...
public class ItemRPGPickaxe extends ItemPickaxe implements IRPGItem.IRPGItemTool, IHasBooksInfo {

    RPGToolMaterial toolMaterial;

    public ItemRPGPickaxe(final RPGToolMaterial toolMaterial) {
