...
public class RPGItemComponent
{
    ...
    static {
        ...
        RPGItemComponent.BOW.init(1.0f, 10.0f, 0.16f, 0.1f, 0.25f, 0.0f, 0.05f, 0.0f, 2.0f, 20.0f, 0.4f, 3.0f, -0.0f, 3.0f);
        RPGItemComponent.SHADOW_BOW.init(4.0f, 10.0f, 0.16f, 0.1f, 0.25f, 0.0f, 0.05f, 0.0f, 4.0f, 16.0f, 0.2f, 4.0f, 4000.0f, 14.0f);
        RPGItemComponent.SNIPER_BOW.init(1.0f, 10.0f, 0.16f, 0.1f, 0.25f, 1.0f, 0.1f, 0.0f, 10.0f, 40.0f, 0.8f, 9.0f, 10000.0f, 22.0f);
    ...
    public static class RPGToolComponent extends RPGItemComponent
    {
        ...
        protected void init(final float meleeDamage, final float meleeSpeed, final float strMul, final float agiMul, final float intMul, final float knBack, final float knbMul, final float reach) {
    ...
    public static class RPGGunComponent extends RPGToolComponent
    {
        ...
        protected void init(final float meleeDamage, final float meleeSpeed, final float strMul, final float agiMul, final float intMul, final float knBack, final float knbMul, final float reach, final float shotDamage, final float shotSpeed, final float shotMinCastTime) {
    ...
    public static class RPGStaffComponent extends RPGGunComponent
    {
        ...
        protected void init(final float meleeDamage, final float meleeSpeed, final float strMul, final float agiMul, final float intMul, final float knBack, final float knbMul, final float reach, final float shotDamage, final float shotSpeed, final float shotMinPower, final float needMana) {
            super.init(meleeDamage, meleeSpeed, strMul, agiMul, intMul, knBack, knbMul, reach, shotDamage, shotSpeed, shotMinPower);
    ...
    public static class RPGBowComponent extends RPGGunComponent implements IWithoutToolMaterial
    {
        ...
        protected void init(final float meleeDamage, final float meleeSpeed, final float strMul, final float agiMul, final float intMul, final float knBack, final float knbMul, final float reach, final float shotDamage, final float shotSpeed, final float shotMinPower, final float shotPower, final float durab, final float ench) {
            super.init(meleeDamage, meleeSpeed, strMul, agiMul, intMul, knBack, knbMul, reach, shotDamage, shotSpeed, shotMinPower);
