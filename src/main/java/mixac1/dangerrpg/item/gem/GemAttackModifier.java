...
public abstract class GemAttackModifier extends Gem {
    ...
    public abstract void onDealtDamage(ItemStack gem, EntityPlayer player, EntityLivingBase target, Stub<Float> damage,
        HashSet<Class<? extends GemAttackModifier>> disableSet);
    ...
    protected static boolean checkDisabling(HashSet<Class<? extends GemAttackModifier>> set,
        Class<? extends GemAttackModifier> obj) {
