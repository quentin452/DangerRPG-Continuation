...
public class GuiRPGWorkbench extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        this.mc.getTextureManager().bindTexture(GuiRPGWorkbench.TEXTURE);
    ...
    protected void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        this.fontRendererObj.drawString(s1, (this.xSize - this.fontRendererObj.getStringWidth(s1)) / 2, GuiRPGWorkbench.nameStrY, 4210752);
