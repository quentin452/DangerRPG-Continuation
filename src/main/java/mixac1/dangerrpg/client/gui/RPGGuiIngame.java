...
public class RPGGuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final ScaledResolution res) {
        ...
        this.renderEntityBar((EntityLivingBase)this.mc.thePlayer, RPGConfig.ClientConfig.d.guiPlayerHUDOffsetX, RPGConfig.ClientConfig.d.guiPlayerHUDOffsetY, RPGConfig.ClientConfig.d.guiPlayerHUDIsInvert, res);
        this.renderChargeBar(RPGConfig.ClientConfig.d.guiChargeIsCentered ? ((width - this.chargeW) / 2) : RPGConfig.ClientConfig.d.guiChargeOffsetX, height - RPGConfig.ClientConfig.d.guiChargeOffsetY);
        this.renderEnemyBar(RPGConfig.ClientConfig.d.guiEnemyHUDOffsetX, RPGConfig.ClientConfig.d.guiEnemyHUDOffsetY, RPGConfig.ClientConfig.d.guiEnemyHUDIsInvert, res);
        GL11.glDisable(3008);
        GL11.glEnable(3042);
        GL11.glPopMatrix();
    ...
    private void renderEntityBar(final EntityLivingBase entity, int offsetX, final int offsetY, final boolean isInverted, final ScaledResolution res) {
        ...
        if (!this.mode.isSimple) {
            GuiInventory.func_147046_a(offsetX + this.invert(18), offsetY + 37, 16, (float)this.invert(30), 0.0f, entity);
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            this.mc.getTextureManager().bindTexture(RPGGuiIngame.TEXTURE);
            this.drawTexturedModalRect(offsetX + this.invert(this.part1X), offsetY + this.part1Y, this.part1U, this.part1V, this.part1Width, this.part1H, isInverted);
            this.drawTexturedModalRect(offsetX + this.invert(this.part2X), offsetY + this.part2Y, this.part2U, this.part2V, this.part2W, this.part2H, isInverted);
            this.drawTexturedModalRect(offsetX + this.invert(this.part3X), offsetY + this.part3Y, this.part3U, this.part3V, this.part3W, this.part3H, isInverted);
        }
        else {
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            this.mc.getTextureManager().bindTexture(RPGGuiIngame.TEXTURE);
        ...
        if (!(entity instanceof EntityPlayer) || !((EntityPlayer)entity).capabilities.isCreativeMode) {
            ...
            final boolean hasFood = !RPGConfig.ClientConfig.d.guiEnableDefaultFoodBar && entity == this.mc.thePlayer && this.mc.thePlayer.getFoodStats().getFoodLevel() < 20;
            ...
            if (hasMana && hasHealth && RPGConfig.ClientConfig.d.guiTwiceHealthManaBar) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 2, this.barIconW, this.barIconH, isInverted);
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal - 2, this.barU, this.barV, this.barW, this.barH, isInverted);
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal + 2, this.barU, this.barV, this.barW, this.barH, isInverted);
                ...
                if (hasHealth) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 0, this.barIconW, this.barIconH, isInverted);
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal, this.barU, this.barV, this.barW, this.barH, isInverted);
                    this.renderHealthBar(entity, offsetX, offsetY + yFal, isInverted);
                    offsetHealth = offsetY + this.barY + yFal;
                    yFal += this.barIconH;
                }
                if (hasMana) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 1, this.barIconW, this.barIconH, isInverted);
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal, this.barU, this.barV, this.barW, this.barH, isInverted);
            ...
            if (hasArmor) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 3, this.barIconW, this.barIconH, isInverted);
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal - 2, this.barU, this.barV, this.barW, this.barH, isInverted);
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal + 2, this.barU, this.barV, this.barW, this.barH, isInverted);
                float curr = HookArmorSystem.getTotalPhisicArmor();
                int proc = this.getProcent(curr, 100.0f, this.barW);
                if (proc > 0) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal - 2, this.barU, this.barV + this.barH * 6, proc, this.barH, isInverted);
                }
                else if (proc < 0) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal - 2, this.barU, this.barV + this.barH * 4, -proc, this.barH, isInverted);
                }
                curr = HookArmorSystem.getTotalMagicArmor();
                proc = this.getProcent(curr, 100.0f, this.barW);
                if (proc > 0) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal + 2, this.barU, this.barV + this.barH * 7, proc, this.barH, isInverted);
                }
                else if (proc < 0) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY + yFal - 2, this.barU, this.barV + this.barH * 4, -proc, this.barH, isInverted);
                }
            ...
            if (hasFood && hasAir) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 6, this.barIconW, this.barIconH, isInverted);
                if (this.mc.thePlayer.isPotionActive(Potion.hunger)) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 5, this.barIconW, this.barIconH, isInverted);
                }
                else {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 4, this.barIconW, this.barIconH, isInverted);
                }
            ...
            if (hasMeleeDamage && this.mode.isDigital) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 7, this.barIconW, this.barIconH, isInverted);
                offsetMeleeDmg = offsetY + this.barIconY + yFal;
                yFal += this.barIconH;
            }
            if (hasRangeDamage && this.mode.isDigital) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barIconX), offsetY + this.barIconY + yFal, this.barIconU, this.barIconV + this.barIconH * 8, this.barIconW, this.barIconH, isInverted);
                offsetRangeDmg = offsetY + this.barIconY + yFal;
                yFal += this.barIconH;
            }
            if (this.mode.isDigital) {
                if (hasMana && hasHealth && RPGConfig.ClientConfig.d.guiTwiceHealthManaBar) {
                    final String s = Utils.toString(this.genValueStr(entity.getHealth() + entity.getAbsorptionAmount()), "/", this.genValueStr((float)PlayerAttributes.CURR_MANA.getValue(entity)));
                    this.fr.drawStringWithShadow(s, offsetX + this.getOffsetX(s, this.barX + this.barW + 4, isInverted), offsetHealth + (this.barIconH - this.fr.FONT_HEIGHT) / 2 - 1, 16777215);
                }
                else {
                    if (hasHealth) {
                    ...
                    if (hasMana) {
                        ...
                        this.fr.drawStringWithShadow(s, offsetX + this.getOffsetX(s, this.barX + this.barW + 4, isInverted), offsetMana + (this.barIconH - this.fr.FONT_HEIGHT) / 2 - 1, 16777215);
                    }
                }
            }
            if (hasMeleeDamage && this.mode.isDigital) {
                final String s = this.genValueStr((float)iRPG.getEAMeleeDamage(entity).getValue(entity));
                this.fr.drawStringWithShadow(s, offsetX + this.getOffsetX(s, this.barX, isInverted), offsetMeleeDmg + (this.barIconH - this.fr.FONT_HEIGHT) / 2 + 1, 16777215);
            }
            if (hasRangeDamage && this.mode.isDigital) {
                final String s = this.genValueStr((float)iRPG.getEARangeDamage(entity).getValue(entity));
                this.fr.drawStringWithShadow(s, offsetX + this.getOffsetX(s, this.barX, isInverted), offsetRangeDmg + (this.barIconH - this.fr.FONT_HEIGHT) / 2 + 1, 16777215);
            }
        }
        String s = entity.getCommandSenderName();
        this.fr.drawStringWithShadow(s, offsetX + this.getOffsetX(s, this.part2X + 1, this.part2W - 6, isInverted), offsetY + this.part2Y + (this.part2H - this.fr.FONT_HEIGHT) / 2 + 2, 16777215);
        if (iRPG != null) {
    ...
    private void renderHealthBar(final EntityLivingBase entity, final int offsetX, final int offsetY, final boolean isInverted) {
        ...
        if (max > 0.0f) {
            ...
            if (entity.isPotionActive(Potion.wither)) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV + this.barH * 4, this.barW, this.barH, isInverted);
            }
            else {
                if (proc > 0) {
                    if (entity.isPotionActive(Potion.poison)) {
                        this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV + this.barH * 3, proc, this.barH, isInverted);
                    }
                    else {
                        this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV + this.barH * 1, proc, this.barH, isInverted);
                    }
                }
                if (procAbsorb > 0) {
                    this.drawTexturedModalRect(offsetX + this.invert(this.barX) + proc, offsetY + this.barY, this.barU + proc, this.barV + this.barH * 2, procAbsorb, this.barH, isInverted);
                }
            }
        }
    }
    ...
    private void renderManaBar(final EntityLivingBase entity, final int offsetX, final int offsetY, final boolean isInverted) {
        ...
        if (max > 0.0f) {
            final int proc = this.getProcent(curr, max, this.barW);
            if (proc > 0) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV + this.barH * 5, proc, this.barH, isInverted);
            }
        }
    }
    ...
    private void renderFoodBar(final EntityLivingBase entity, final int offsetX, final int offsetY, final boolean isInverted) {
        ...
        if (curr < 20.0f) {
            this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV, this.barW, this.barH, isInverted);
            if (this.mc.thePlayer.isPotionActive(Potion.hunger)) {
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV + this.barH * 9, proc, this.barH, isInverted);
            }
            else {
                this.drawTexturedModalRect(offsetX + this.invert(this.barX), offsetY + this.barY, this.barU, this.barV + this.barH * 8, proc, this.barH, isInverted);
            }
        }
    }
    ...
    public void renderChargeBar(final int offsetX, final int offsetY) {
        ...
        if ((stack = this.mc.thePlayer.getItemInUse()) != null && stack.getItemUseAction() == EnumAction.bow && ItemAttributes.SHOT_SPEED.hasIt(stack)) {
            ...
            if (proc > 0) {
                this.drawTexturedModalRect(offsetX, offsetY, this.chargeU, this.chargeV + this.chargeH, proc, this.chargeH);
            }
            if (ItemAttributes.MIN_CUST_TIME.hasIt(stack)) {
                ...
                this.drawTexturedModalRect(offsetX + proc, offsetY, this.chargeU, this.chargeV + this.chargeH * 2, 1, this.chargeH);
            }
        }
    }
        ...
        if (mop != null && mop.entityHit != null) {
            if (mop.entityHit instanceof EntityDragonPart) {
                if (((EntityDragonPart)mop.entityHit).entityDragonObj instanceof EntityDragon) {
                    this.renderEntityBar((EntityLivingBase)((EntityDragonPart)mop.entityHit).entityDragonObj, offsetX, offsetY, true, res);
                }
            }
    ...
    public void drawTexturedModalRect(final int x, final int y, final int u, final int v, final int width, final int heght, final boolean isInverted) {
        ...
        if (!isInverted) {
            tessellator.addVertexWithUV((double)(x + 0), (double)(y + heght), (double)this.zLevel, (double)((u + 0) * f), (double)((v + heght) * f));
            tessellator.addVertexWithUV((double)(x + width), (double)(y + heght), (double)this.zLevel, (double)((u + width) * f), (double)((v + heght) * f));
            tessellator.addVertexWithUV((double)(x + width), (double)(y + 0), (double)this.zLevel, (double)((u + width) * f), (double)((v + 0) * f));
            tessellator.addVertexWithUV((double)(x + 0), (double)(y + 0), (double)this.zLevel, (double)((u + 0) * f), (double)((v + 0) * f));
        }
        else {
            tessellator.addVertexWithUV((double)(x - width), (double)(y + heght), (double)this.zLevel, (double)((u + width) * f), (double)((v + heght) * f));
            tessellator.addVertexWithUV((double)(x + 0), (double)(y + heght), (double)this.zLevel, (double)((u + 0) * f), (double)((v + heght) * f));
