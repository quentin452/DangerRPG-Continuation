...
public abstract class GuiInfoBookContent extends GuiScrollingList {
    ...
    public GuiInfoBookContent(final Minecraft mc, final int width, final int height, final int top, final int size,
        final int left, final int entryHeight, final GuiInfoBook parent) {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float par3) {
        ...
        this.parent.drawTexturedModalRect(
            this.left,
            this.top - this.slotHeight,
            this.left - offsetX,
            this.top - offsetY - this.slotHeight,
            this.listWidth,
            this.slotHeight);
        this.parent.drawTexturedModalRect(
            this.left,
