...
{
    public static Block[] getRandomBlocksInSetRange(final World world, final int x, final int y, final int z, final int range, final int passes) {
        return getRandomBlocksInSetRangeWithRandomChance(world, x, y, z, range, passes, 4);
    }
    
    public static Block[] getRandomBlocksInSetRangeWithRandomChance(final World world, final int x, final int y, final int z, final int range, final int passes, final int chance) {
        return null;
    }
    ...
    public static Block[] getRandomBlocksInSetRangeWithPrejudiceWithRandomChance(final World world, final Set set, final int range, final int chance) {
        return null;
    }
    ...
    public static Entity[] getRandomEntitiesInRangeWithRandomChance(final World world, final Entity entity, final double range, final int chance) {
        return null;
    }
    ...
    public static ArrayList<int[]> getBlocksInCircularRange(final World world, final double radius, final double x, final double y, final double z) {
    ...
    public static ArrayList<int[]> getBlocksInSphericalRange(final World world, final double radius, final double x, final double y, final double z) {
        final ArrayList<int[]> list = new ArrayList<int[]>();
        if (radius <= 0.0) {
            throw new IllegalArgumentException("Radius cannot be negative!");
        }
    ...
    public static int getDistanceToGround(final World world, final int x, final int y, final int z) {
        for (int i = 0; y - i > 0; ++i) {
            if (world.getBlock(x, y - i, z).getMaterial().blocksMovement()) {
                return i;
            }
        }
        return y;
