...
public class EventHandlerClient {
    ...
    public void renderRPGGuiIngame(final RenderGameOverlayEvent.Post event) {
        if (!event.isCancelable() && event.type == RenderGameOverlayEvent.ElementType.ALL
            && RPGConfig.ClientConfig.d.guiEnableHUD) {
    ...
    public void renderDisableOldBars(final RenderGameOverlayEvent.Pre event) {
        if (RPGConfig.ClientConfig.d.guiEnableHUD && (event.type == RenderGameOverlayEvent.ElementType.HEALTH
            || event.type == RenderGameOverlayEvent.ElementType.ARMOR
            || (!RPGConfig.ClientConfig.d.guiEnableDefaultFoodBar
