...
public abstract class RecipeCreator
{
    ...
    public static class RecipeArmor
    {
        ...
        public static void addRecipe(final Item[] results, final Object item) {
            for (int i = 0; i < results.length; ++i) {
                GameRegistry.addShapedRecipe(new ItemStack(results[i]), new Object[] { RecipeArmor.patterns[i], '0', item });
            }
        }
        
        static {
            RecipeArmor.patterns = new String[][] { { "000", "0 0" }, { "0 0", "000", "000" }, { "000", "0 0", "0 0" }, { "0 0", "0 0" } };
        }
    }
    ...
    public static class RecipeMageArmor
    {
        ...
        public static void addRecipe(final Item[] results, final Object[] armor, final Object item) {
            for (int i = 0; i < results.length; ++i) {
                GameRegistry.addShapedRecipe(new ItemStack(results[i]), new Object[] { RecipeMageArmor.patterns[i], '1', armor[i], '0', item });
            }
        }
        
        static {
            RecipeMageArmor.patterns = new String[][] { { " 1 ", "000" }, { "010", "000" }, { " 0 ", "010" }, { "010" } };
        }
    }
