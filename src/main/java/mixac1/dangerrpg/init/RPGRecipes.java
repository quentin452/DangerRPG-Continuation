...
public abstract class RPGRecipes
{
    public static void load(final FMLPreInitializationEvent e) {
        RecipeSorter.register(Utils.toString("dangerrpg", ":", LargeShapedRecipe.NAME), (Class)LargeShapedRecipe.class, RecipeSorter.Category.SHAPED, "after:minecraft:shaped");
        RecipeSorter.register(Utils.toString("dangerrpg", ":", LargeShapelessRecipe.NAME), (Class)LargeShapelessRecipe.class, RecipeSorter.Category.SHAPELESS, "after:minecraft:shapeless");
        RecipeSorter.register(Utils.toString("dangerrpg", ":colorArmorDyes"), (Class)RecipeColorArmorDyes.class, RecipeSorter.Category.SHAPED, "after:minecraft:shaped");
        ...
        addLargeShapedRecipe(RPGBlocks.syntheticBedrock, " 000 ", "01210", "02320", "01210", " 000 ", '0', RPGItems.compressedObsidian, '1', Blocks.lapis_block, '2', Items.diamond, '3', Blocks.diamond_block);
        addLargeShapedRecipe(RPGItems.blackMatter, "0000", "0110", "0110", "0000", '0', RPGItems.compressedBedrock, '1', Items.emerald);
        ...
        final Object[][] materials1 = { { Items.stick, Blocks.planks, Blocks.planks }, { Items.stick, Blocks.cobblestone, Blocks.cobblestone }, { Items.stick, Items.iron_ingot, Items.iron_ingot }, { Items.stick, Items.gold_ingot, Items.gold_ingot }, { Items.stick, Items.diamond, Items.diamond }, { RPGItems.stickObsidian, RPGItems.compressedObsidian, Items.blaze_rod }, { RPGItems.stickDiamond, RPGItems.compressedBedrock, Items.emerald }, { RPGItems.stickBlackMatter, RPGItems.blackMatter, RPGItems.blackMatter }, { RPGItems.stickWhiteMatter, RPGItems.whiteMatter, RPGItems.whiteMatter } };
        ...
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_AXE, new Item[] { RPGItems.axeObsidian, RPGItems.axeBedrock, RPGItems.axeBlackMatter, RPGItems.axeWhiteMatter }, materials3);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_PICKAXE, new Item[] { RPGItems.pickaxeObsidian, RPGItems.pickaxeBedrock, RPGItems.pickaxeBlackMatter, RPGItems.pickaxeWhiteMatter }, materials3);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_SHOVEL, new Item[] { RPGItems.shovelObsidian, RPGItems.shovelBedrock, RPGItems.shovelBlackMatter, RPGItems.shovelWhiteMatter }, materials3);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_HOE, new Item[] { RPGItems.hoeObsidian, RPGItems.hoeBedrock, RPGItems.hoeBlackMatter, RPGItems.hoeWhiteMatter }, materials3);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_SWORD, new Item[] { RPGItems.swordObsidian, RPGItems.swordBedrock, RPGItems.swordBlackMatter, RPGItems.swordWhiteMatter }, materials3);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_MULTITOOL, new Item[] { RPGItems.multitoolWood, RPGItems.multitoolStone, RPGItems.multitoolIron, RPGItems.multitoolGold, RPGItems.multitoolDiamond, RPGItems.multitoolObsidian, RPGItems.multitoolBedrock, RPGItems.multitoolBlackMatter, RPGItems.multitoolWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_KNIFE, new Item[] { RPGItems.knifeWood, RPGItems.knifeStone, RPGItems.knifeIron, RPGItems.knifeGold, RPGItems.knifeDiamond, RPGItems.knifeObsidian, RPGItems.knifeBedrock, RPGItems.knifeBlackMatter, RPGItems.knifeWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_TOMAHAWK, new Item[] { RPGItems.tomahawkWood, RPGItems.tomahawkStone, RPGItems.tomahawkIron, RPGItems.tomahawkGold, RPGItems.tomahawkDiamond, RPGItems.tomahawkObsidian, RPGItems.tomahawkBedrock, RPGItems.tomahawkBlackMatter, RPGItems.tomahawkWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_KATANA, new Item[] { RPGItems.katanaWood, RPGItems.katanaStone, RPGItems.katanaIron, RPGItems.katanaGold, RPGItems.katanaDiamond, RPGItems.katanaObsidian, RPGItems.katanaBedrock, RPGItems.katanaBlackMatter, RPGItems.katanaWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_NAGINATA, new Item[] { RPGItems.naginataWood, RPGItems.naginataStone, RPGItems.naginataIron, RPGItems.naginataGold, RPGItems.naginataDiamond, RPGItems.naginataObsidian, RPGItems.naginataBedrock, RPGItems.naginataBlackMatter, RPGItems.naginataWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_SCYTHE, new Item[] { RPGItems.scytheWood, RPGItems.scytheStone, RPGItems.scytheIron, RPGItems.scytheGold, RPGItems.scytheDiamond, RPGItems.scytheObsidian, RPGItems.scytheBedrock, RPGItems.scytheBlackMatter, RPGItems.scytheWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_HAMMER, new Item[] { RPGItems.hammerWood, RPGItems.hammerStone, RPGItems.hammerIron, RPGItems.hammerGold, RPGItems.hammerDiamond, RPGItems.hammerObsidian, RPGItems.hammerBedrock, RPGItems.hammerBlackMatter, RPGItems.hammerWhiteMatter }, materials1);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_STAFF, new Item[] { RPGItems.staffGold, RPGItems.staffDiamond, RPGItems.staffObsidian, RPGItems.staffBedrock, RPGItems.staffBlackMatter, RPGItems.staffWhiteMatter }, materials2);
        RecipeCreator.createRecipes(RecipeCreator.RECIPE_POWER_STAFF, new Item[] { RPGItems.powerStaffGold, RPGItems.powerStaffDiamond, RPGItems.powerStaffObsidian, RPGItems.powerStaffBedrock, RPGItems.powerStaffBlackMatter, RPGItems.powerStaffWhiteMatter }, materials2);
    ...
    public static ItemStack ownFindMatchingRecipe(final InventoryCrafting inv, final World world, final int invWidth, final int invHeight) {
        ...
        if (i == 2 && stack.getItem() == stack2.getItem() && stack.stackSize == 1 && stack2.stackSize == 1 && stack.getItem().isRepairable()) {
        ...
        for (final Object obj : CraftingManager.getInstance().recipes) {
            ...
            if (irecipe.getClass() == ShapelessRecipes.class) {
                ...
                if ((irecipe instanceof LargeShapedRecipe || irecipe instanceof LargeShapelessRecipe || irecipe.getClass() == ShapelessOreRecipe.class) && irecipe.matches(inv, world)) {
                    return irecipe.getCraftingResult(inv);
                }
                continue;
            }
            ...
            for (int j = 0; j < invHeight; ++j) {
                ...
                if (stack != null) {
                    ...
                    for (final ItemStack stack2 : list) {
                        if (stack.getItem() == stack2.getItem() && (stack2.getItemDamage() == 32767 || stack.getItemDamage() == stack2.getItemDamage())) {
                            flag = true;
                            list.remove(stack2);
                            break;
                        }
