...
public abstract class RPGRecipes {
    ...
    public static void load(FMLPreInitializationEvent e) {
        RecipeSorter.register(
            Utils.toString(DangerRPG.MODID, ":", LargeShapedRecipe.NAME),
            LargeShapedRecipe.class,
            SHAPED,
            "after:minecraft:shaped");
        RecipeSorter.register(
            Utils.toString(DangerRPG.MODID, ":", LargeShapelessRecipe.NAME),
            LargeShapelessRecipe.class,
            SHAPELESS,
            "after:minecraft:shapeless");
        RecipeSorter.register(
            Utils.toString(DangerRPG.MODID, ":colorArmorDyes"),
            RecipeColorArmorDyes.class,
            SHAPED,
            "after:minecraft:shaped");
        ...
        Object[][] materials1 = new Object[][] { { Items.stick, Blocks.planks, Blocks.planks },
    ...
    public static ItemStack ownFindMatchingRecipe(InventoryCrafting inv, World world, int invWidth, int invHeight) {
        ...
        if (i == 2 && stack.getItem() == stack1.getItem()
            && stack.stackSize == 1
            && stack1.stackSize == 1
            && stack.getItem()
                .isRepairable()) {
            ...
            for (Object obj : CraftingManager.getInstance().recipes) {
                ...
                else if (irecipe instanceof LargeShapedRecipe || irecipe instanceof LargeShapelessRecipe
    ...
    private static boolean matches(ShapelessRecipes recipe, InventoryCrafting inv, World world, int invWidth,
        int invHeight) {
                ...
                if (stack != null) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (stack.getItem() == stack1.getItem()
                            && (stack1.getItemDamage() == 32767 || stack.getItemDamage() == stack1.getItemDamage())) {
                            flag = true;
                            list.remove(stack1);
                            break;
                        }
