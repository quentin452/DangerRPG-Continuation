...
public abstract class RPGItems
{
    ...
    public static String getRPGName(final RPGItemComponent.RPGToolComponent toolComponent, final RPGToolMaterial toolMaterial) {
        return Utils.toString(toolComponent.name, "_", toolMaterial.name);
    }
    
    public static String getRPGName(final RPGItemComponent.RPGArmorComponent armorComponent, final RPGArmorMaterial armorMaterial) {
    ...
    static {
        ...
        RPGItems.naginataBlackMatter = (Item)new ItemRPGWeapon(RPGToolMaterial.BLACK_MATTER, RPGItemComponent.NAGINATA);
        RPGItems.naginataWhiteMatter = (Item)new ItemRPGWeapon(RPGToolMaterial.WHITE_MATTER, RPGItemComponent.NAGINATA);
        ...
        RPGItems.tomahawkBlackMatter = (Item)new ItemRPGTomahawk(RPGToolMaterial.BLACK_MATTER, RPGItemComponent.TOMAHAWK);
        RPGItems.tomahawkWhiteMatter = (Item)new ItemRPGTomahawk(RPGToolMaterial.WHITE_MATTER, RPGItemComponent.TOMAHAWK);
        ...
        RPGItems.powerStaffBlackMatter = (Item)new ItemPowerStaff(RPGToolMaterial.BLACK_MATTER, RPGItemComponent.POWER_STAFF);
        RPGItems.powerStaffWhiteMatter = (Item)new ItemPowerStaff(RPGToolMaterial.WHITE_MATTER, RPGItemComponent.POWER_STAFF);
        ...
        RPGItems.armorObsidian = (Item[])ItemRPGArmor.createFullSet(RPGArmorMaterial.OBSIDIAN, RPGItemComponent.RPGArmorComponent.ARMOR);
        RPGItems.armorBedrock = (Item[])ItemRPGArmor.createFullSet(RPGArmorMaterial.BEDROCK, RPGItemComponent.RPGArmorComponent.ARMOR);
        RPGItems.armorBlackMatter = (Item[])ItemRPGArmor.createFullSet(RPGArmorMaterial.BLACK_MATTER, RPGItemComponent.RPGArmorComponent.ARMOR);
        RPGItems.armorWhiteMatter = (Item[])ItemRPGArmor.createFullSet(RPGArmorMaterial.WHITE_MATTER, RPGItemComponent.RPGArmorComponent.ARMOR);
        RPGItems.mageArmorCloth = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.CLOTH, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorIron = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.IRON, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorGold = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.GOLD, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorDiamond = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.DIAMOND, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorObsidian = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.OBSIDIAN, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorBedrock = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.BEDROCK, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorBlackMatter = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.BLACK_MATTER, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
        RPGItems.mageArmorWhiteMatter = (Item[])ItemMageArmor.createFullSet(RPGArmorMaterial.WHITE_MATTER, RPGItemComponent.RPGArmorComponent.MAGE_ARMOR);
