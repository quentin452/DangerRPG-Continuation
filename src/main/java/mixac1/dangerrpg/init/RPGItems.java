...
public abstract class RPGItems {
    ...
    public static Item tomahawkBlackMatter = new ItemRPGTomahawk(
        RPGToolMaterial.BLACK_MATTER,
        RPGItemComponent.TOMAHAWK);
    public static Item tomahawkWhiteMatter = new ItemRPGTomahawk(
    ...
    public static Item powerStaffBlackMatter = new ItemPowerStaff(
        RPGToolMaterial.BLACK_MATTER,
        RPGItemComponent.POWER_STAFF);
    public static Item powerStaffWhiteMatter = new ItemPowerStaff(
        RPGToolMaterial.WHITE_MATTER,
        RPGItemComponent.POWER_STAFF);
    ...
    public static Item[] armorBlackMatter = ItemRPGArmor
        .createFullSet(RPGArmorMaterial.BLACK_MATTER, RPGArmorComponent.ARMOR);
    public static Item[] armorWhiteMatter = ItemRPGArmor
        .createFullSet(RPGArmorMaterial.WHITE_MATTER, RPGArmorComponent.ARMOR);

    public static Item[] mageArmorCloth = ItemMageArmor
        .createFullSet(RPGArmorMaterial.CLOTH, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorIron = ItemMageArmor
        .createFullSet(RPGArmorMaterial.IRON, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorGold = ItemMageArmor
        .createFullSet(RPGArmorMaterial.GOLD, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorDiamond = ItemMageArmor
        .createFullSet(RPGArmorMaterial.DIAMOND, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorObsidian = ItemMageArmor
        .createFullSet(RPGArmorMaterial.OBSIDIAN, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorBedrock = ItemMageArmor
        .createFullSet(RPGArmorMaterial.BEDROCK, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorBlackMatter = ItemMageArmor
        .createFullSet(RPGArmorMaterial.BLACK_MATTER, RPGArmorComponent.MAGE_ARMOR);
    public static Item[] mageArmorWhiteMatter = ItemMageArmor
        .createFullSet(RPGArmorMaterial.WHITE_MATTER, RPGArmorComponent.MAGE_ARMOR);
