...
public abstract class RPGRenderers
{
    ...
    private static void registerItemRenderer() {
        ...
        MinecraftForgeClient.registerItemRenderer(RPGItems.naginataBlackMatter, (IItemRenderer)RenderLongItem.INSTANCE);
        MinecraftForgeClient.registerItemRenderer(RPGItems.naginataWhiteMatter, (IItemRenderer)RenderLongItem.INSTANCE);
    ...
    private static void registerEntityRenderingHandler() {
        ...
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityMaterial.class, (Render)RenderMaterial.INSTANCE);
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityRPGArrow.class, (Render)RenderArrowRPG.INSTANCE);
        RenderingRegistry.registerEntityRenderingHandler((Class)EntitySniperArrow.class, (Render)RenderArrowRPG.INSTANCE);
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityThrowKnife.class, (Render)RenderThrowKnife.INSTANCE);
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityThrowTomahawk.class, (Render)RenderThrowTomahawk.INSTANCE);
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityMagicOrb.class, (Render)RenderMagicOrb.INSTANCE);
        RenderingRegistry.registerEntityRenderingHandler((Class)EntityPowerMagicOrb.class, (Render)RenderMagicOrb.INSTANCE);
    }
