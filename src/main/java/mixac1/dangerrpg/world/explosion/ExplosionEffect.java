...
public abstract class ExplosionEffect {
    ...
    public abstract void doEffect(final double p0, final double p1, final double p2, final double p3,
        final Object[] p4);
    ...
    static {
        ...
        EMPTY = new ExplosionEffect() {
            ...
            @Override
            public void doEffect(final double x, final double y, final double z, final double size,
                final Object[] meta) {}
        };
                ...
                for (double frec = 3.141592653589793 / (6.0 * size), k = 0.0; k < 6.283185307179586; k += frec) {
                    ...
                    for (double l = 0.0; l < 6.283185307179586; l += frec) {
                        ...
                        DangerRPG.proxy.spawnEntityFX(
                            (RPGEntityFXManager.IEntityFXType) RPGEntityFXManager.EntityReddustFXE,
                            x2,
                            y2,
                            z2,
                            0.0,
