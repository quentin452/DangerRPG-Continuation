...
public class EntityRPGArrow extends EntityMaterial
{
    ...
    public EntityRPGArrow(final World world, final ItemStack stack, final EntityLivingBase thrower, final float speed, final float deviation) {
        super(world, thrower, new ItemStack(Items.arrow, 1), speed, deviation);
        this.setStack(stack, 26);
    }
    
    public EntityRPGArrow(final World world, final ItemStack stack, final EntityLivingBase thrower, final EntityLivingBase target, final float speed, final float deviation) {
