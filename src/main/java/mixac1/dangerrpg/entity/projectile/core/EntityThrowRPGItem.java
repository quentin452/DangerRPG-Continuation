...
public class EntityThrowRPGItem extends EntityMaterial
{
    ...
    public EntityThrowRPGItem(final World world, final ItemStack stack, final double x, final double y, final double z) {
        super(world, stack, x, y, z);
    }
    
    public EntityThrowRPGItem(final World world, final EntityLivingBase thrower, final ItemStack stack, final float speed, final float deviation) {
        super(world, thrower, stack, speed, deviation);
    }
    
    public EntityThrowRPGItem(final World world, final EntityLivingBase thrower, final EntityLivingBase target, final ItemStack stack, final float speed, final float deviation) {
    ...
    public void applyEntityHitEffects(final EntityLivingBase entity, final float dmgMul) {
        ...
        if (stack != null) {
            ...
            final ItemStackEvent.HitEntityEvent event = new ItemStackEvent.HitEntityEvent(stack, entity, this.thrower, this.phisicDamage, 0.0f, true);
        ...
        if (this.thrower instanceof EntityPlayer) {
            MinecraftForge.EVENT_BUS.post((Event)new ItemStackEvent.DealtDamageEvent((EntityPlayer)this.thrower, entity, stack, points));
        }
    }
}
