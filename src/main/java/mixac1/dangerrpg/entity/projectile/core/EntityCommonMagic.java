...
public class EntityCommonMagic extends EntityWithStack
{
    ...
    public EntityCommonMagic(final World world, final EntityLivingBase thrower, final ItemStack stack, final float speed, final float deviation) {
        super(world, thrower, stack, speed, deviation);
    }
    
    public EntityCommonMagic(final World world, final EntityLivingBase thrower, final EntityLivingBase target, final ItemStack stack, final float speed, final float deviation) {
    ...
    public void applyEntityHitEffects(final EntityLivingBase entity, final float dmgMul) {
        ...
        if (stack != null) {
            ...
            final ItemStackEvent.HitEntityEvent event = new ItemStackEvent.HitEntityEvent(stack, entity, this.thrower, (float)this.damage, 0.0f, true);
