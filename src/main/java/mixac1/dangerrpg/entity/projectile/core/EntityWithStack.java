...
public abstract class EntityWithStack extends EntityProjectile
{
    ...
    public EntityWithStack(final World world, final EntityLivingBase thrower, final ItemStack stack, final float speed, final float deviation) {
        super(world, thrower, speed, deviation);
        this.setStack(stack);
    }
    
    public EntityWithStack(final World world, final EntityLivingBase thrower, final EntityLivingBase target, final ItemStack stack, final float speed, final float deviation) {
