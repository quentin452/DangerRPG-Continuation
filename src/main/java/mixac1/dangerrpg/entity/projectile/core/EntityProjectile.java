...
public class EntityProjectile extends EntityArrow implements IThrowableEntity
{
    ...
    public EntityProjectile(final World world, final EntityLivingBase thrower, final float speed, final float deviation) {
        this(world);
    ...
    public EntityProjectile(final World world, final EntityLivingBase thrower, final EntityLivingBase target, final float speed, final float deviation) {
    ...
    public void setThrowableHeading(final double x, final double y, final double z, final float speed, final float deviation) {
    ...
    public void onEntityUpdate() {
        ...
        if (i != null) {
            ...
            final AxisAlignedBB axisalignedbb = i.getCollisionBoundingBoxFromPool(this.worldObj, this.field_145791_d, this.field_145792_e, this.field_145789_f);
    ...
    public MovingObjectPosition findMovingObjectPosition() {
        ...
        if (entity != null) {
            ...
            if (mop.entityHit instanceof EntityPlayer) {
                ...
                if (entityplayer.capabilities.disableDamage || (this.thrower instanceof EntityPlayer && this.thrower != null && !((EntityPlayer)this.thrower).canAttackPlayer(entityplayer))) {
                    mop = null;
                }
            }
        }
    ...
    public void applyEntityHitEffects(final EntityLivingBase entity, final float dmgMul) {
        ...
        if (this.thrower != null) {
            ...
            if (this.thrower instanceof EntityPlayerMP && this.thrower != entity && entity instanceof EntityPlayer) {
                ((EntityPlayerMP)this.thrower).playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(6, 0.0f));
            }
    ...
    public boolean needAimRotation() {
        return this.inGround || (!this.inGround && (!this.canRotation() || (this.getRotationOnYaw() == 0.0f && this.getRotationOnPitch() == 0.0f)));
    }
